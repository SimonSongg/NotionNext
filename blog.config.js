...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '17828e52eef24a49a2a4988ee316806f'
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Tianchen Song', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Engineer', // 作者简介
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/SimonSongg', // 你的github个人主页 例如 https://github.com/tangly1024
